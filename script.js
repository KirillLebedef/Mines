...
document.addEventListener("DOMContentLoaded", () => {
    ...
    plusBtn.addEventListener("click", () => {
        if (count < 7) {
            ...
            updateCounter();
            telegramVibrate('impact', 'medium'); // Вибрация при нажатии на плюс
        } else {
            telegramVibrate('notification', 'warning'); // Вибрация при превышении лимита
        }
    });
    ...
    getSignalBtn.addEventListener("click", () => {
        ...
        telegramVibrate('impact', 'medium'); // Вибрация при успешном нажатии кнопки
