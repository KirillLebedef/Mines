...
document.addEventListener("DOMContentLoaded", () => {
    ...
    plusBtn.addEventListener("click", () => {
        if (count < 7) {
            ...
            updateCounter();
            vibrate(50); // Вибрация при нажатии на плюс
        }
    });
    ...
    minusBtn.addEventListener("click", () => {
        if (count > 1) {
            ...
            updateCounter();
            vibrate(50); // Вибрация при нажатии на минус
        }
    });
    ...
    getSignalBtn.addEventListener("click", () => {
        if (isCooldown) {
            ...
            vibrate(50); // Вибрация при попытке нажать во время кулдауна
            return;
        }
            ...
            if (!selectedCells.includes(index)) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        vibrate(50); // Вибрация при появлении звезды
                    }, 0);
        ...
        isCooldown = true;
        vibrate(50); // Вибрация при успешном нажатии кнопки
...
// Предотвращение масштабирования через двойное касание
